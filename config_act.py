...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        if dataset_name=='volleyball':
            self.data_path='/data/kirill/volleyball_activity/Group-Activity-Recognition/data/volleyball'  #data path for the volleyball dataset
    ...
    def init_config(self, need_new_folder):
